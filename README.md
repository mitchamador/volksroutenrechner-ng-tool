...
Веб-инструмент для работы с данными [маршрутного компьютера](https://github.com/mitchamador/volksroutenrechner-ng#volksroutenrechner-ng-1): журнал поездок (trip C/A/B,
